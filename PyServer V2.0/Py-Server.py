    ...
    def do_POST(self):
        ...
        if self.path=="/send1":
            ...
            try:
                ...
                #--write the content                    
                    text_file.write(htmlBuilderPre+htmlBuilderHeadStart+htmlBuilderHeadMid+htmlBuilderHeadStop+htmlBuilderBodyStart+htmlBuilderBodyMid1_1+htmlBuilderBodyMid1_1_1+htmlBuilderBodyMid22+htmlBuilderBodyMid33+htmlBuilderBodyMid4+htmlBuilderBodyMid1_2_1+htmlBuilderBodyMid2+htmlBuilderBodyMid3+htmlBuilderBodyMid4+htmlBuilderBodyMid1_3_1+htmlBuilderBodyMid2+htmlBuilderBodyMid3+htmlBuilderBodyMid4+htmlBuilderBodyStop+htmlbuilderPost)
                #--return the html
                #time.sleep(100)
        ...
        if self.path=="/send2":
            ...
            try:
                ...
                with open(homeDIR+"index"+str(rValueArr[0])+".html", "w") as text_file:
                #--write the content
                    text_file.write(htmlBuilderPre+htmlBuilderHeadStart+htmlBuilderHeadMid+htmlBuilderHeadStop+htmlBuilderBodyStart+htmlBuilderBodyMid1_2+htmlBuilderBodyMid1_2_1+htmlBuilderBodyMid22+htmlBuilderBodyMid33+htmlBuilderBodyMid4+htmlBuilderBodyMid1_3_1+htmlBuilderBodyMid2+htmlBuilderBodyMid3+htmlBuilderBodyMid4+htmlBuilderBodyMid1_1_1+htmlBuilderBodyMid2+htmlBuilderBodyMid3+htmlBuilderBodyMid4+htmlBuilderBodyStop+htmlbuilderPost)
                #--return the html
                #time.sleep(100)
                initHtml(self,"index"+str(rValueArr[0])+".html")
                #--clear the file once html rendered
        ...
        if self.path=="/send3":
            ...
            try:
                ...
                with open(homeDIR+"index"+str(rValueArr[0])+".html", "w") as text_file:
                #--write the content
                    text_file.write(htmlBuilderPre+htmlBuilderHeadStart+htmlBuilderHeadMid+htmlBuilderHeadStop+htmlBuilderBodyStart+htmlBuilderBodyMid1_3+htmlBuilderBodyMid1_3_1+htmlBuilderBodyMid22+htmlBuilderBodyMid33+htmlBuilderBodyMid4+htmlBuilderBodyMid1_1_1+htmlBuilderBodyMid2+htmlBuilderBodyMid3+htmlBuilderBodyMid4+htmlBuilderBodyMid1_2_1+htmlBuilderBodyMid2+htmlBuilderBodyMid3+htmlBuilderBodyMid4+htmlBuilderBodyStop+htmlbuilderPost)
                #--return the html
                #time.sleep(100)
                initHtml(self,"index"+str(rValueArr[0])+".html")
                #--clear the file once html rendered
