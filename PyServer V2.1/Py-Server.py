        ...
        if self.path=="/send1":
            ...
            try:
                ...
                for rValue in rValueArr:
                    ...
                    rows = PDC.getData(rValue,"VCCNB","VPX","VM")
                    if rows <> "Error":
        ...
        if self.path=="/send2":
            ...
            try:
                ...
                for rValue in rValueArr:
                    ...
                    #---Cascading if else condition No : 1
                    print "Cascading if else condition No : 1"
                    rows = PDC.getData(rValue,"VCCNB","VPX","ESX")
                    if rows <> "Error":
                        ...
                        if rows <> "Error":
                            ...
                            if rows <> "Error":
                                ...
                                if rows <> "Error":
                                          ...
                                          for row in rows:
                                                    print row.VMID, row.NAME, row.DATASTORE_NAME,row.VMGROUPID, row.Mem_Resv
                                                    htmlBuilderBodyMid33=datamodifier_2(self,htmlBuilderBodyMid33,row)
                ...
                with open(homeDIR+"index"+str(rValueArr[0])+".html", "w") as text_file:
                #--write the content
                    text_file.write(htmlBuilderPre+htmlBuilderHeadStart+htmlBuilderHeadMid+htmlBuilderHeadStop+htmlBuilderBodyStart+htmlBuilderBodyMid1_2+htmlBuilderBodyMid1_2_1+htmlBuilderBodyMid22+htmlBuilderBodyMid33+htmlBuilderBodyMid4+htmlBuilderBodyMid1_3_1+htmlBuilderBodyMid2_DS+htmlBuilderBodyMid3_DS+htmlBuilderBodyMid4+htmlBuilderBodyMid1_1_1+htmlBuilderBodyMid2_VM+htmlBuilderBodyMid3_VM+htmlBuilderBodyMid4+htmlBuilderBodyStop+htmlbuilderPost)
                #--return the html
                #time.sleep(100)
                initHtml(self,"index"+str(rValueArr[0])+".html")
                #--clear the file once html rendered
        ...
        if self.path=="/send3":
            ...
            try:
                ...
                for rValue in rValueArr:                    
                    ...
                    #---Cascading if else condition No : 1
                    print "Cascading if else condition No : 1"
                    rows = PDC.getData(rValue,"VCCNB","VPX","DS")
                    if rows <> "Error":
                ...
                with open(homeDIR+"index"+str(rValueArr[0])+".html", "w") as text_file:
                #--write the content
                    text_file.write(htmlBuilderPre+htmlBuilderHeadStart+htmlBuilderHeadMid+htmlBuilderHeadStop+htmlBuilderBodyStart+htmlBuilderBodyMid1_3+htmlBuilderBodyMid1_3_1+htmlBuilderBodyMid22+htmlBuilderBodyMid33+htmlBuilderBodyMid4+htmlBuilderBodyMid1_1_1+htmlBuilderBodyMid2_VM+htmlBuilderBodyMid3_VM+htmlBuilderBodyMid4+htmlBuilderBodyMid1_2_1+htmlBuilderBodyMid2_ESX+htmlBuilderBodyMid3_ESX+htmlBuilderBodyMid4+htmlBuilderBodyStop+htmlbuilderPost)
                #--return the html
                #time.sleep(100)
                initHtml(self,"index"+str(rValueArr[0])+".html")
                #--clear the file once html rendered
